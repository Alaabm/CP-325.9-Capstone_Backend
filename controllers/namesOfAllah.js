...
async function update(req, res) {
    try {
        const updatedNameOfAllah = await NameOfAllah.findByIdAndUpdate(req.params.id, req.body, {
            new: true,
        })
...
async function destroy(req, res) {
    try {
        const deletedNameOfAllah = await NameOfAllah.findByIdAndDelete(req.params.id)
